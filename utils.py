...
def generate_script(subject, Video_length, creativity, api_key):
    ...
    model = ChatOpenAI(
        model="gpt-3.5-turbo",
        api_key="sk-iRkcNnGf62BanwyqLIEqJd1bnU38ooDSk9nUnu4nSCKnCwJQ",
    ...
    # 直接调用 wikipedia-api 搜索，无额外函数
    wiki = wikipediaapi.Wikipedia(language='zh', extract_format=wikipediaapi.ExtractFormat.WIKI)
